...
class main_DB():
    ...
    def updateRow(self,U_column ,U_Name, U_T_Value):
        # Veri Güncelleme
        self.select_DB.execute("UPDATE cargosystem SET " + U_column + " = '" + U_T_Value +  "' where Ad " + "= '" + U_Name +"'")
    ...
    def createRow(self, newrowlist):
        ...
        "Security,Box_Location,Cabin_Num,Cargo_Start_Time,Cargo_End_Time) VALUES (" + "'" + newrowlist[0] + "'" + "," +
        "'" + newrowlist[1] + "'" + "," + "'" + newrowlist[2] + "'" + "," + "'" + newrowlist[3] + "'" + "," + "'" +
        newrowlist[4] + "'" + "," + "'" + newrowlist[5] + "'" + "," + "'" +newrowlist[6] + "'" + "," + "'" +
        newrowlist[7] + "'" + "," + "'" + newrowlist[8] + "'" + "," + "'" + newrowlist[9] + "'" + "," + "'" +
