    ...
    def __init__(self, mail_type, knowledge):
        ...
        if mail_type == "Creating_Cargo":
            ...
            self.msgText = MIMEText("<p><b>Sayın " + knowledge[0] + " " + knowledge[1] + ";</b></p>" +
                                    "<p><b>" + str(knowledge[4]) + "</b>" + " Takip numaralı kargonuz " + "<b>" + datetime +
                                    "</b>" + " tarihinde " + "<b>" + knowledge[6] + "</b>" + " şubemize teslim edilmek " +
                                    ...
                                    str(knowledge[5]) + "</b>" + " PNR numaranız veya QR Kodunuz ile teslim alabilirsiniz." +
            ...
            self.msgText = MIMEText("<p><b>Sayın " + knowledge[0][0] + " " + knowledge[0][1] + ";</b></p>" +
                                    "<p><b>" + str(knowledge[0][4]) + "</b>" + " Takip numaralı kargonuz " + "<b>" + datetime +
                                    "</b>" + " tarihinde " + "<b>" + knowledge[0][6] + "</b>" + " şubemize teslim edilmiştir.</p>" +
        ...
        elif mail_type == "Creating_SafetyLocker":
            message["To"] = knowledge[3]
            # msgText = MIMEText('<b>Sayın </b> and an image.<br><img src="cid:image1"><br>Nifty!', 'html')
            self.msgText = MIMEText("<p><b>Sayın " + knowledge[0] + " " + knowledge[1] + ";</b></p>" +
                                    "<p><b>" + str(knowledge[5]) + "</b>" + " PNR numaralı emanetiniz " + "<b>" + datetime +
                                    "</b>" + " tarihinde " + "<b>" + knowledge[6] + "</b>" + " şubemize bırakılmıştır.<p>" +
                                    "</p>Emanetinizi aşağıda adresi bulunan SafetyBox'ımızdan" + "<b>" " PNR numaranız" +
                                    "</b>" + " veya " + "<b>" + "QR Kodunuz" + "</b>" + " ile teslim alabilirsiniz." +
                                    "<p><b>Şube adresimiz :</b> " + knowledge[6] + "  " + knowledge[8] + " / " +
                                    knowledge[9] + "</p>" +
                                    "<p><b>Adres Tarifi : </b>" + " " + knowledge[7] + "</p>" +
        ...
        elif mail_type == "Receiving_Locker":
            message["To"] = knowledge[0]
            receiver_Person_ID = message["To"].split("@")
            self.msgText = MIMEText("<p><b>Sayın " + knowledge[1] + " " + knowledge[2] + ";</b></p>" +
                                    "<p><b>" + str(knowledge[3]) + "</b>" + " PNR numaralı emanetiniz aşağıda resmi bulunan " +
                                    "kişi tarafından teslim alınmıştır.</p>" +
                                    "<p><b><i>SafetyBox'ı seçtiğiniz için teşekkür ederiz.</b></i></p>" +
