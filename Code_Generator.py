...
class Code_Generator():
    ...
    def create_Tracking(self, n):  # create n digit random number
    ...
    def create_PNR(self, n):  # create n digit random number
    ...
    def create_QRCode(self, first_parameter, surname, name, county, city):
